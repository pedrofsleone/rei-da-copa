...
- **Ajuste Fase A - Home poster mobile (2026-07-04)**: Pedro enviou 3 referencias visuais geradas. Para a pagina inicial, a decisao atual e seguir a imagem 1 exatamente: fundo branco/grunge/grafite com jogadores amarelo/verde, titulo "REI DA COPA", "TEMPORADA 2026", botao verde **SOLO CPU/Offline** e botao amarelo **MULTIPLAYER Jogue com os amigos**. Implementacao local em `index.html`: `body.is-home-screen` esconde a topbar apenas na home; `homeView` agora contem `.home-poster`; os botoes mantem os IDs originais `homeCpuBtn` e `openMultiBtn`, mas viraram hotspots transparentes sobre a arte para preservar clique e navegacao. Novo asset local: `assets/home-poster.jpg`, gerado a partir de `C:\Users\pedro\OneDrive\Documentos\REI_DA_COPA\Gemini_Generated_Image_xbn76wxbn76wxbn7.png`, comprimido para carregar melhor no telefone. Imagens 2 e 3 ficam como referencia futura para refazer Draft/Tutorial no mesmo estilo, mas nesta etapa so a home foi alterada.
